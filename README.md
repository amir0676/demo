...
![](snapshots/20251119225616.png)

Файл `/var/lib/bind/db.0.168.192`:

![](snapshots/20251008163759.png)

Файл `/var/lib/bind/db.1.168.192`:

![](snapshots/20251008163837.png)
...
![](snapshots/20251118233347.png)

Также у данного веб-приложения есть инструкция:

![](snapshots/20251118233604.png)
...
![](snapshots/20251123002745.png)

Далее пробуем авторизоваться доменным пользователем:

![](snapshots/20251123003000.png)
### Задание 3-2
...
![](snapshots/20260227085516.png)

- Для `docker.au-team.irpo`:

![](snapshots/20260227085455.png)
